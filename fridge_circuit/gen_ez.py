#!/usr/bin/env python3
"""Generate DXF using ezdxf, then fix header manually."""
import ezdxf
import os
...
def TX(x,y,t,h,lyr="TEXT"):
    txt = ec(t)
    msp.add_text(txt, dxfattribs={"layer":lyr,"height":h}).set_placement((x,y))
...
# Save first version
tmp = r"C:\Users\zero\.openclaw\workspace\fridge_circuit\fridge_tmp.dxf"
doc.saveas(tmp)

# Now read as text and fix header
with open(tmp, "r", encoding="cp1252") as f:
    text = f.read()

# Fix $EXTMIN and $EXTMAX
# Replace the default values with our bounds
text = text.replace(" 10\n1e+20\n 20\n1e+20\n 30\n1e+20\n  9\n$EXTMAX", " 10\n0.0\n 20\n0.0\n 30\n0.0\n  9\n$EXTMAX")
text = text.replace(" 10\n-1e+20\n 20\n-1e+20\n 30\n-1e+20\n  9\n$LIMMIN", " 10\n450.0\n 20\n280.0\n 30\n0.0\n  9\n$LIMMIN")

out = r"C:\Users\zero\.openclaw\workspace\fridge_circuit\fridge_v2.dxf"
